...
class Window_DebugHairColor < Window_Command
	...
	def make_command_list
		add_command("", :colorCurrent, true, "#{CheatsMod.getTextInfo("modules/haircoloredit:command_ext")}")
	end
...
module YEA
	module DEBUG
		COMMANDS.insert(4, [:haircolor, "#{CheatsMod.getTextInfo("modules/haircoloredit:command_desc")}"])
	end
end
...
class Scene_Debug
	...
	def command_haircolor
		...
		refresh_help_window(:haircolor, "#{CheatsMod.getTextInfo("modules/haircoloredit:command_help_0")}\n#{CheatsMod.getTextInfo("modules/haircoloredit:command_help_1")}\n#{CheatsMod.getTextInfo("modules/haircoloredit:command_help_2")}\n#{CheatsMod.getTextInfo("modules/haircoloredit:command_help_3")}")
	end
