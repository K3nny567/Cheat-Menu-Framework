...
module CheatUtils
	def self.ingame?
		return (!SceneManager.scene_is?(Scene_MapTitle) and !SceneManager.scene_is?(Scene_AdultContentWarning) and !SceneManager.scene_is?(Scene_Title) and $loading_screen.nil?)
	end
end
